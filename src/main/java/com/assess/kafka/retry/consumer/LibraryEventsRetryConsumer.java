...
public class LibraryEventsRetryConsumer {
    ...
    @Value(value = "${spring.kafka.library.bootstrap-servers:")
    private String bootstrapServer;
    @Value(value = "${spring.kafka.library.consumer.group-id:")
    ...
    public ConsumerFactory<String, LibraryEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(),
                new JsonDeserializer<>(LibraryEvent.class));
    }

    @Bean("kafkaListenerContainerFactory")
    public ConcurrentKafkaListenerContainerFactory<String, LibraryEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, LibraryEvent> concurrentKafkaListenerContainerFactory
